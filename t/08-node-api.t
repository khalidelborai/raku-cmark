...
nok $h.is-leaf, "heading is not a leaf (it contains inlines)";
my $htext = $h.first-child;
is $htext.type, CMARK_NODE_TEXT, "heading contains a text node";
ok $htext.is-leaf, "a text node is a leaf";
nok $doc.node.is-leaf, "document is not a leaf";
my $list = $h.next;
